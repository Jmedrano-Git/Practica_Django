...
urlpatterns = [
    ...
    path('asignar-organizador/<int:pk>/', views.asignar_organizador, name="asignar_organizador"),
    path('organizador/toggle/<int:organizador_id>/', views.toggle_Organizador, name='toggle_organizador'),
]
